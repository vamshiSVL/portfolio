...
const Home = ({ visible }) => {
  ...
  return (
    <>
      <motion.div className='w-full px-6 md:w-[81%] md:mx-[200px] overflow-hidden'>
        <div className='h-[800px] flex flex-col md:flex-row justify-around items-center relative'>
          <motion.div
            initial={{ x: -500 }}
            animate={{ x: [-500, 1300] }}
