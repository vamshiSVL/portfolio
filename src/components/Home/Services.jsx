  ...
  return (
    <div className='flex justify-around h-[700px] mx-[-30px]'>
      <div data-aos='fade-up'>
        <h3 data-aos='fade-left' className='font-extrabold text-2xl'>My Awesome</h3>
      ...
      <div className='relative'>
        <div data-aos='fade-left' className='w-56 h-64 bg-slate-100 border-4 rounded-lg border-[#EBBA18] absolute left-[-150px] flex flex-col justify-center items-center gap-2 p-5'>
        ...
        <div data-aos='fade-right' className='w-56 h-64 border-4 bg-slate-100 rounded-lg border-[#EBBA18] absolute left-[-500px] top-60 flex flex-col justify-center items-center gap-2 p-5'>
